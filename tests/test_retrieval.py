...
def test_bm25_search_returns_results():
    docs = [make_doc("The capital of France is Paris."), make_doc("Python is a programming language.")]
...
def test_hybrid_rrf_deduplicates(monkeypatch):
    chunk = {"text": "Paris is the capital of France.", "metadata": {"source": "test.txt"}, "fused_score": 0.5}
